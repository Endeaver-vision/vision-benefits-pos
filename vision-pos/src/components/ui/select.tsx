  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "focus:bg-white/[0.12] focus:border-primary focus:ring-[3px] focus:ring-primary/20",
        "disabled:cursor-not-allowed disabled:opacity-50",
        "aria-invalid:border-destructive aria-invalid:ring-destructive/20",
        "[&_svg:not([class*='text-'])]:text-muted-foreground",
        "data-[size=default]:h-11 data-[size=sm]:h-9 data-[size=sm]:rounded-xl data-[size=sm]:px-3",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "rounded-2xl border border-white/15 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.4),inset_0_1px_0_0_rgba(255,255,255,0.1)]",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer items-center gap-2 rounded-xl py-2.5 pr-10 pl-3 text-sm outline-hidden select-none transition-colors duration-150",
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("bg-white/10 pointer-events-none -mx-1 my-1.5 h-px", className)}
      {...props}
    />
  )
}
