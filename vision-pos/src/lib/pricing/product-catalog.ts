...
export const ADD_ONS: Product[] = [
  {
    ...
    wholesale: 0.0,
    retail: 10.0,
    vspTier: "Tech Addon SV",
    eyemedTier: "N/A",
    specteraTier: "N/A",
    cashOnly: false,
    note: "VSP Tech Addon for Single Vision lenses",
  },
  {
    id: "tech_addon_mf",
    name: "Tech Addon (M/F)",
    ...
    wholesale: 0.0,
    retail: 40.0,
    vspTier: "Tech Addon MF",
    eyemedTier: "N/A",
    specteraTier: "N/A",
    cashOnly: false,
    note: "VSP Tech Addon for Multifocal lenses",
  },
  {
    id: "uv",
    name: "UV Treatment",
    ...
    specteraTier: "Add-On",
    cashOnly: false,
    note: "Standard UV - auto-added to all glasses",
  },
  {
    id: "uv_backside",
    name: "UV Backside",
    ...
    specteraTier: "Add-On",
    cashOnly: false,
    note: "Backside UV - used with AR coatings",
  },
  {
    id: "eyemed_backside_uv_surcharge",
    name: "Backside UV Surcharge",
    category: "add_on",
    wholesale: 0.0,
    retail: 15.0,
    vspTier: "N/A",
    eyemedTier: "Backside UV",
    specteraTier: "N/A",
    cashOnly: false,
    note: "EyeMed backside UV surcharge for AR coatings",
  },
  {
    id: "tint",
    name: "Tint",
